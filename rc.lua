...
local editor       = os.getenv("EDITOR") or "em"
...
globalkeys = mytable.join(
    ...
    awful.key({ "Control", modkey, altkey          }, "space", function() naughty.destroy_all_notifications() end,
...
awful.spawn.with_shell('exec ~/programs/clash/cfw >> /dev/null 2>&1')
